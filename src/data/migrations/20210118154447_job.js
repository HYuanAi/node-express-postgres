...
const DROP_ON_UPDATE_DATE_FN = 'DROP FUNCTION on_update_date';
...
exports.up = (knex) => {
    ...
    knex.schema.createTable("job", table => {
        ...
        knex.raw(ON_UPDATE_DATE_FN);
        knex.raw(ON_JOB_UPDATE_TRIGGER);
    })
};

exports.down = (knex) => {
    knex.schema.dropTableIfExists("job").then(() => 
